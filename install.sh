...
echo 'export PICONTROLLER_HUB_IP="127.0.0.1"' >> $HOME/user_configuration/configuration.env
echo "export PICONTROLLER_HUB_USER=$USER" >> $HOME/user_configuration/configuration.env
echo "export PICONTROLLER_PROJECT_PATH=$PICONTROLLER_PROJECT_PATH" >> $HOME/user_configuration/configuration.env
